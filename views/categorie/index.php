<section class="flex justify-center items-center gap-5 my-5 text-center">
    <a href="index.php?controller=categorie&action=creer" class="bg-blue-900 text-xl rounded-2xl p-3 text-white hover:border hover:border-blue-900 hover:text-blue-900 hover:bg-gray-100 duration-300 cursor-pointer">
        Ajouter une Catégorie
        <span class="fa-solid fa-plus"></span>
    </a>
</section>

<main class="w-6xl mx-auto">
